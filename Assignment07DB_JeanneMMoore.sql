--*************************************************************************--
-- Title: Assignment07
-- Author: Jeanne M Moore
-- Desc: This file demonstrates how to use Functions
-- Change Log: When,Who,What
-- 2020-12-2 Jeanne M Moore created file
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_JeanneMMoore')
	 Begin 
	  Alter Database [Assignment07DB_JeanneMMoore] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_JeanneMMoore;
	 End
	Create Database Assignment07DB_JeanneMMoore;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_JeanneMMoore;
